...
The project conducted in the context of the databases course of Msc in Data Science. The aim was to create and querying a database for a library using SQL.
